...
Dette er min første CTF-writeup, der jeg går gjennom hvordan jeg løste oppgavene jeg klarte under Cybertalent sin 2025-CTF. 
Under ligger en oversikt over oppgavene fra både 1.Grunnleggende og 2.Oppdrag, og [x] på de som jeg klarte.
Jeg har ikke vært flink nok til å ta notater eller skjermbilder på alle oppgavene. Jeg har derfor kun inkludert de løsningene som er dokumentert godt nok til å presenteres videre. 
```
1. Grunnleggende
1.1    [x] Scoreboard
1.2    [x] Username
...
1.10   [x] Breakout
1.11.1 [x] Solveme
1.11.2 [x] Solveme Del 2
1.11.3 [x] Solveme Del 3
...
2.2    [x] Digifil
2.3    [ ] Maskerte poter
2.5    [x] Eye of the Tiger
2.6    [x] Cplusminus
2.7.1  [x] Trappetrinn
2.7.2  [x] Trappetrinn David
2.7.3  [x] Trappetrinn Priya
2.7.4  [x] Trappetrinn ROOT
2.8    [x] Flagle
2.9    [ ] Musikktrøbbel
2.10   [ ] VAE
2.11   [x] Karapeks
...
2.17   [x] Tagware
2.18   [ ] Bitcoin
2.19.1 [x] Kaffemaskin
2.19.2 [x] Kaffemaskin ROOT
